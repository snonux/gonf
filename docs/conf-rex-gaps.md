...
Refreshed 2026-09-23 against **gonf v0.16.3**; this release uses plan schema
...
Status against every conf Rex primitive in v0.16.3 (plan schema 24):

| Conf Rex capability | gonf v0.16.3 | Status |
|---------------------|--------------|--------|
...
- Every capability row names the gonf API that exists today (verified against
  v0.16.3, plan schema 24) — no "fleet needs transport" or
